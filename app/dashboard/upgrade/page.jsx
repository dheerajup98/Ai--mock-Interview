...
function Upgrade() {
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
    <div  className="rounded-2xl border border-indigo-600 p-6 shadow-sm ring-1 ring-indigo-600 sm:order-last sm:px-8 lg:p-12" >
      ...
      <a
        href="https://buy.stripe.com/test_cN23ex7HucUwdzy4gg"
    ...
    <div className="rounded-2xl border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
      <div className="text-center">
        ...
        <p className="mt-2 sm:mt-4">
          <strong className="text-3xl font-bold text-gray-900 sm:text-4xl"> 14$ </strong>
      ...
      <a
        href="https://buy.stripe.com/test_8wM02l7HudYA9ji4gh"
